...
std::pair<std::uint16_t, std::uint16_t> PUSH(State& state, Instruction& instruction, std::uint8_t* op_code);
std::pair<std::uint16_t, std::uint16_t> INC(State& state, Instruction& instruction, std::uint8_t* op_code);
std::pair<std::uint16_t, std::uint16_t> DEC(State& state, Instruction& instruction, std::uint8_t* op_code);
std::pair<std::uint16_t, std::uint16_t> DAA(State& state, Instruction& instruction, std::uint8_t* op_code);
std::pair<std::uint16_t, std::uint16_t> CPL(State& state, Instruction& instruction, std::uint8_t* op_code);
std::pair<std::uint16_t, std::uint16_t> ADD(State& state, Instruction& instruction, std::uint8_t* op_code);
std::pair<std::uint16_t, std::uint16_t> ADC(State& state, Instruction& instruction, std::uint8_t* op_code);
std::pair<std::uint16_t, std::uint16_t> SUB(State& state, Instruction& instruction, std::uint8_t* op_code);
std::pair<std::uint16_t, std::uint16_t> SBC(State& state, Instruction& instruction, std::uint8_t* op_code);
std::pair<std::uint16_t, std::uint16_t> AND(State& state, Instruction& instruction, std::uint8_t* op_code);
std::pair<std::uint16_t, std::uint16_t> XOR(State& state, Instruction& instruction, std::uint8_t* op_code);
std::pair<std::uint16_t, std::uint16_t> OR(State& state, Instruction& instruction, std::uint8_t* op_code);
...
std::pair<std::uint16_t, std::uint16_t> RLA(State& state, Instruction& instruction, std::uint8_t* op_code);
std::pair<std::uint16_t, std::uint16_t> RRCA(State& state, Instruction& instruction, std::uint8_t* op_code);
std::pair<std::uint16_t, std::uint16_t> RRA(State& state, Instruction& instruction, std::uint8_t* op_code);
std::pair<std::uint16_t, std::uint16_t> RLC(State& state, Instruction& instruction, std::uint8_t* op_code);
std::pair<std::uint16_t, std::uint16_t> RRC(State& state, Instruction& instruction, std::uint8_t* op_code);
std::pair<std::uint16_t, std::uint16_t> RL(State& state, Instruction& instruction, std::uint8_t* op_code);
std::pair<std::uint16_t, std::uint16_t> RR(State& state, Instruction& instruction, std::uint8_t* op_code);
std::pair<std::uint16_t, std::uint16_t> SLA(State& state, Instruction& instruction, std::uint8_t* op_code);
